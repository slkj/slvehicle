	...
	<div id="tt" class="easyui-tabs" data-options="border:false">
		<div title="基本信息" id="jiben">
			<table class="grid">
				...
				<table class="grid">
				<tr>
					<th colspan="6" style="text-align:center">驾驶证信息</th>
				</tr>
				<tr>
					<th>发证机关：</th>
					<td><input  name="driver_authority" type="text" style="width: 200px;" ></td>
					<th>驾驶证号：</th>
					<td><input class="easyui-validatebox"  name="driver_no" type="text"  data-options="required:true"  style="width: 200px;"></td>
					</tr>
				<tr>
					<th>准驾车型：</th>
					<td><input  id="car_type" class="easyui-combobox" data-options="required:true" name="driver_car_type" style="width: 200px;"/> <!--             <select name="driver_car_type" style="width: 200px;"> --> <!-- 							<option value=""></option> --> <!-- 							<option value="C1">C1</option> --> <!-- 							<option value="C2">C2</option> --> <!-- 							<option value="C3">C3</option> --> <!-- 							<option value="A1">A1</option> --> <!-- 							<option value="A1">A2</option> --> <!-- 							<option value="A1">A3</option> -->
					</td>
					<th>驾驶证初领时间：</th>
					<td><input name="driver_certify_time" data-options="required:true" class="easyui-datebox" type="text" style="width: 200px;"></td>
					</tr>
				<tr>
					<th>驾驶证有效期始：</th>
					<td><input name="driver_begin_time" data-options="required:true"  class="easyui-datebox" type="text" style="width: 200px;"></td>
					<th>驾驶证有效期截至：</th>
					<td><input name="driver_end_time" class="easyui-datebox"  data-options="required:true"  type="text" style="width: 200px;"></td>
				</tr>
				<tr>
					<th>经营许可证号：</th>
					<td><input name="bussiness_no" style="width: 200px;" type="text"></td>
				...
				<tr>
					<th>联系地址：</th>
					<td colspan="4"><input name="address" type="text" style="width: 600px;"></td>
				</tr>
			</table></div>
		...
		<div title="违章记录" id="weizhang">
			<div data-options="region:'center'">
						<table id="drivergrid" data-options="border:false">
						
						</table>
						</div>
		</div>
		<div title="驾驶证审验记录" id="shenyan">
			<div data-options="region:'center'">
						<table id="exzmgrid" data-options="border:false">
