...
<body>
	<form id="uform">
		...
		<input name="entryId" type="hidden" value="${userSession.u_id }" /> 
		<input name="entryName" type="hidden" value="${userSession.username }" /> 
		<input name="depId" type="hidden" value="${userSession.departcode }" />
			...
			<div title="注册登记摘要信息">
				<table class="grid">
					<tr>
						...
						</select> / <input id="regNum" name="regNum" class="easyui-validatebox"  style="width: 150px;" /></td>
					</tr>
					<tr>
						<th>联系人:</th>
...
<!-- 									<input  type="button" name="button" class="btn" value="上传"  onclick="uploadImg()"/>  -->
									<a id="btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icons_44'" onclick="uploadImg()">上传</a>  
									<input id="img" type="hidden" name="carImg"/>
							</div> 
						</td>
					</tr>
				</table>
				...
				<table class="grid">
					...
					<tr>
						...
						<td><select class="easyui-combobox" name="classify"
							...
							style="width: 200px;"
							data-options="url:'vehicle/carcalss_data.json',required:true,lines:true"></select>
						</td>
						<th>车辆品牌：</th>
					...
					<tr>
						...
						<td><input id="carApproved" name="carApproved"
							class="easyui-numberbox" tyle="width: 200px;" />kg</td>
					</tr>
					<tr>
						<th>核定载客：</th>
					...
					<tr>
						...
						<td><input id="carCabGuest" name="carCabGuest"
							class="easyui-numberbox" style="width: 200px;" />人</td>
						<th>使用性质：</th>
						<td><select id="carUseNatu" class="easyui-combobox" name="carUseNatu"
